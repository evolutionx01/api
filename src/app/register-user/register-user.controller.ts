...
export class RegisterUserController {
  ...
  async addProduct(
    ...
    @Body('birth_time') consBirthTime: number,
    ...
    @Body('file') consFile: string,
  ) {
    const generatedData = await this.registerUserService.insertUser(
      consName,
      consBirthDate,
      consBirthDay,
      consBirthTime,
  ...
  async removeProduct(@Param('id') userId: string) {
    await this.registerUserService.deleteProduct(userId);
